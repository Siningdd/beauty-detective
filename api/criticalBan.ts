/**
 * Critical ingredient hard-block — API copy (keep in sync with ../services/criticalBan.ts).
 * Inlined so Node/tsx does not lose named exports on re-export from parent dir.
 */
